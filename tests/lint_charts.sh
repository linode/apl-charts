...
helm lint spin-app --values=tests/test-values.yaml
helm lint spin-operator --values=tests/test-values.yaml
helm lint spin-shim-executor --values=tests/test-values.yaml