...
*/}}
{{- define "otomi-quickstart-k8s-deployment-otel.fullname" -}}
...
app.kubernetes.io/name: {{ include "otomi-quickstart-k8s-deployment-otel.fullname" . }}
app.kubernetes.io/owner: {{ .Release.Namespace }}
otomi.io/app: {{ include "otomi-quickstart-k8s-deployment-otel.fullname" . }}
