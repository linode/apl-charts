...
*/}}
{{- define "otomi-k8s-deployment-with-otel.fullname" -}}
...
app.kubernetes.io/name: {{ include "otomi-k8s-deployment-with-otel.fullname" . }}
app.kubernetes.io/owner: {{ .Release.Namespace }}
otomi.io/app: {{ include "otomi-k8s-deployment-with-otel.fullname" . }}
{{- end }}
...
{{- define "volumeMounts" }}
{{- $name := (include "otomi-k8s-deployment-with-otel.fullname" .) }}
{{- with .Values }}
